...
public class FlappyScrappyLearnsToFly extends Activity implements AdListener {
	/** Called when the activity is first created. */
	public static CCGLSurfaceView mGLSurfaceView;
	private boolean isCreated = false; 

	private static final String ADMOB_PUBLISH_ID = "ca-app-pub-4955708376154717/1769209611";
	...
	public void exitGameDialog() {
		Builder builder = new AlertDialog.Builder(FlappyScrappyLearnsToFly.this)
	...
	private void loadSound() {
		...
		Common.sound_engine.preloadEffect(CCDirector.sharedDirector().getActivity().getApplication(), R.raw.boing);
