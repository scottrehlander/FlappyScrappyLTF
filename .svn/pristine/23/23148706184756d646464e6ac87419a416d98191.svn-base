...
////////////////////////////////////////////////////
	...
	public static Boolean loadActions()
	{
	    ...
	    //}
	    animation = CCAnimation.animation("", .2f);
	    animation.addFrame("bird1_1.png");
	    animation.addFrame("bird1_2.png");
	    animation.addFrame("bird1_3.png");
	    animation.addFrame("bird1_4.png");
	    ...
	    //}
	    animation = CCAnimation.animation("", .2f);
	    animation.addFrame("bird2_1.png");
	    animation.addFrame("bird2_2.png");
	    animation.addFrame("bird2_3.png");
	    animation.addFrame("bird2_4.png");
	    ani_bird2 = CCAnimate.action(animation);
	    expArray0.removeAll(expArray0);
	    ...
	    for (int n = 0; n < 4; n++) {
	        ...
	        for (int i = 0; i < 13; i++) {
	        	...
	        	animation.addFrame(String.format("01000%02d.png", n+1, i+1));
	        }
	    ...
	    animation.addFrame("010000fail1.png");
	    animation.addFrame("010000fail2.png");
	    animation.addFrame("010000fail3.png");
	    animation.addFrame("010000fail4.png");
	    ani_panda_face_fail = CCAnimate.action(animation, false);
	...
	public static MetricsUserInfo getMetricInfo(){
		SharedPreferences p = CCDirector.sharedDirector().getActivity().getApplicationContext().getSharedPreferences("metricsInfo", 0);
		if(!p.contains("userId")){
			return null;
		}
		
		return new MetricsUserInfo(p.getInt("userId", -1), p.getInt("timesOpened", -1));
	}
	
	public static void setMetricInfo(int userId, int timesOpened)
	{
		SharedPreferences p = CCDirector.sharedDirector().getActivity().getApplicationContext().getSharedPreferences("metricsInfo", 0);
		Editor ed = p.edit();
		ed.putInt("userId", userId);
		ed.putInt("timesOpened", timesOpened);
		ed.commit();
	}
