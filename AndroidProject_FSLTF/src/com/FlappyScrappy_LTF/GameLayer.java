...
import com.FlappyScrappy_LTF.Common.GameState;
...
public class GameLayer extends CCLayer {
	...
	public final float STATE_COMPLETE_LENGTH =  35000.0f;//1000f;//35000.0f;
	public final float START_POS_PLAYER_Y = (80 * Common.kYForIPhone);

	public final float SCORE_LENGTH_X = (15 * Common.kXForIPhone);
	public final float SCORE_LENGTH_Y = (15 * Common.kYForIPhone);

	public final float PAUSE_X    =     (435 * Common.kXForIPhone);
	public final float PAUSE_Y    =     (280 * Common.kYForIPhone);
    ...
    private void initButtons()
    {
        ...
        pauseMenuItem.setScaleX(.25F * Common.kXForIPhone);
        pauseMenuItem.setScaleY(.25F * Common.kYForIPhone);
        pauseMenuItem.setPosition(PAUSE_X, PAUSE_Y);
        
        resumeMenuItem = CCMenuItemImage.item("resume.png", "resume1.png", this, "onResume");
        resumeMenuItem.setScaleX(.25F * Common.kXForIPhone);
        resumeMenuItem.setScaleY(.25F * Common.kYForIPhone);
        ...
        retryMenuItem.setScaleX(.25F * Common.kXForIPhone);
        retryMenuItem.setScaleY(.25F * Common.kYForIPhone);
        ...
        menuMenuItem.setScaleX(.25F * Common.kXForIPhone);
        menuMenuItem.setScaleY(.25F * Common.kYForIPhone);
    ...
    private void initDot_Lines()
    {
        ...
        for (int i = 0; i < dotArrayCount; i ++) {
            ...
            dot_line.setScaleX(.5F * Common.kXForIPhone);
            dot_line.setScaleY(.5F * Common.kYForIPhone);
            ...
            dot_start.setScaleX(.25F * Common.kXForIPhone);
            dot_start.setScaleY(.25F * Common.kYForIPhone);
            ...
            dot_end.setScaleX(.25F * Common.kXForIPhone);
            dot_end.setScaleY(.25F * Common.kYForIPhone);
    ...
    private void initGame()
    {
        ...
        player.state = Flappy.PandaState_none;
                
        player.velocity = CGPoint.ccp(0, 0);
        player.state = Flappy.PandaState_start;
        player.stateDirect = Flappy.DirectState.DirectState_down;
    ...
    public void initImages()
    {
        ...
        drawHere.setScale(.5F * Common.kXForIPhone);
	...
	public boolean dotIntersectWithLine(Flappy target, CGPoint line_start, CGPoint line_end)
    {
    ...
    public void playerBounsed(CGPoint line_start, CGPoint line_end)
    {
        ...
        float nextTime = -player.velocity.y / Flappy.GRAVITY * 2;
    ...
    public void restartGame()
    {
        ...
        float vel_Y = Common.SCREEN_WIDTH / 2 / DEFAULT_MOVE_VEL_X * Flappy.GRAVITY / 2 * (-1);
    ...
    public void collisionScanWithFoods()
    {
        ...
        for (int i = 0; i < arrayCount; i ++) {
            Coin food = moveLayer.foods.get(i);
            ...
            if (player.state == Flappy.PandaState_fast) {
            ...
            if ( CGRect.intersects(rect, food.rect()) ) {
                ...
                switch (food.type) {
                    case SKULL:
                        if (player.state == Flappy.PandaState_protect) {
                            break;
                        }
    ...
    private void updateFlayLengthLabel()
    {
        ...
        String string = String.format("%d", player.score);
        lblScoreLength.setString(string);
    }
    
    private int calculateScore()
    {
    	int totalScore = player.flayLength / 10;
    	totalScore = totalScore + (coinsGathered * 25);
    	return totalScore;
    }
    ...
    public void cameraMove()
    {
        ...
        tryAgain.setScale(.5F * moveLayer.getScaleX() * Common.kXForIPhone);
        keepOn.setScale(.5F * moveLayer.getScaleX() * Common.kXForIPhone);
        goolLuck.setScale(.5F * moveLayer.getScaleX() * Common.kXForIPhone);
    }
	...
	public boolean ccTouchesBegan(MotionEvent event)
	{
	    ...
	    for (int i = 0; i < dotArrayCount; i ++) {
	        ...
	        if (line.getVisible() == false) {
	            ...
	            line.setScaleY(.25F * Common. kYForIPhone);
